<?php
	 ...
	 * @author sol (sol@ngleader.com) / delphiXE (admin@folderfile.net) 翻譯:royallin
	...
	$lang->planet_myplanet = "我的微網誌";
	$lang->planet_whos_planet = "%s 的微網誌";
	$lang->planet_whos_favorite = "%s 的最愛";
	$lang->planet_whos_favorite_list = "'%s'的微網誌清單";
	$lang->planet_favorite = "的最愛";

	$lang->planet_welcome = "歡迎光臨！";

	$lang->planet_reply_content = "微網誌的回覆內容";

	$lang->about_planet =
		"XE微網誌模組，可讓會員建立自己的微網誌。
		 虛擬網站模組所使用的網域名稱無法用於微網誌模組。
		 如果想將微網誌當作首頁，請先在網站模組中設定其他的網域名稱。";

	$lang->planet_mid = "微網誌連結網址";
	$lang->about_planet_mid = "可以直接輸入網址訪問，微網誌連結網址是「http://主程式網址/微網誌網址」。";

	$lang->planet_default_skin = "微網誌面板";
	$lang->about_planet_default_skin = "選擇微網誌面板。";

	$lang->planet_comment = "微網誌簡介";
	$lang->about_planet_comment = "微網誌的簡介，同時也會顯示在瀏覽器的標題。";

	$lang->use_signup = "顯示會員註冊按鈕";
	$lang->about_use_signup = "選擇此項，會在微網誌首頁顯示『會員註冊』按鈕。";

	$lang->cmd_create_planet = "建立我的微網誌";
	$lang->create_message = "微網誌簡介";
	$lang->about_create_message = "簡單地輸入簡介。";

	$lang->cmd_planet_setup = "基本設定";
	$lang->cmd_planet_list = "微網誌列表";

	$lang->msg_not_logged = "請先登入。";
	$lang->msg_planet_exists = "已建立微網誌，無法再新增。";
	...
	$lang->about_planet_make_planet = "建立微網誌。請輸入微網誌的基本資料。";
	$lang->about_planet_make_planet_info = "顯示微網誌的基本資料。當所有項目都輸入完畢後，請儲存您的設定。";
	...
	$lang->cmd_planet_makeOk_move_myplanet = "確認 : 移動到我的微網誌。";
	$lang->cmd_planet_ok_move_myplanet = "確認 : 移動到我的微網誌。";
	...
	$lang->about_planet_whats_textSearch_in_planet = "在<strong>'%s'</strong>的微網誌中搜尋<strong>'%s'</strong>的結果。";
	...
	$lang->planet_notice_title = "%s，歡迎來到微網誌！<br>%s，您可以在微網誌中分享您的想法、意見、資訊以及其他知識喔。以下是簡單的使用說明。^^";
	$lang->planet_notice_list = array(
		"底下的內容輸入區域可以開啟或關閉。",
		"所有瀏覽者都能夠觀看和回覆 %s 的微網誌。",
		"利用「新增最愛」與「喜愛標籤」功能，隨時都能看到%s的喜愛內容。",
		"%s 的「照片、暱稱、標籤」等資料都可在此頁面中進行修改。",
		"對其他微網誌有興趣嗎？請利用『熱門標籤』或『搜尋』。",
		"如果您還有其他問題。請搜尋『問題』標籤。",
	);
	...
	$lang->msg_planet_rss_enabled = "RSS 使用中";
	$lang->msg_planet_rss_disabled = "暫停使用 RSS";

	$lang->msg_me2day_sync = "傳送到 me2day";
	$lang->msg_me2day_sync_q = "確定要傳送到 me2day 嗎？";
	$lang->me2day_id = "me2day網址";
	$lang->me2day_ukey = "User Key";
	$lang->msg_me2day_activate = "自動傳送。";
	$lang->msg_fail_auth_me2day = "Me2day 認證失敗。";
	$lang->msg_success_auth_me2day = "Me2day 認證成功。";
	...
	$lang->about_planet_smstag = "以「,」區分多個標籤，用 SMS 傳送時將自動新增標籤。";
	...
	$lang->msg_search_thisplanet = "搜尋微網誌";
	$lang->msg_welcome_planet = '歡迎加入微網誌^_^';
?>
